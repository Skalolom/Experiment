...
for filename in files:
    ...
    sos = signal.butter(5, 0.0005, output='sos')
    #sos = signal.cheby1(4, 5, 0.01, output='sos')
    pressVect_flt = signal.sosfiltfilt(sos, pressVect, padtype='constant')
    # pressVect_flt = gaussian_filter1d(pressVect_flt, 4)
    # pressVect_flt = savgol_filter(pressVect_flt, 101, 3)
    ...
    plt.plot(timeVect_flt, pressVect_flt, barColor,
